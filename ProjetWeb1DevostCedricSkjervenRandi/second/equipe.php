...
*   Date: 2019-01-29
*   Description: Page php qui liste les entraineurs de l</quipe
*   Fichier: equipe.php
-->
<html lang="fr">
...
<head>
    <meta charset="utf-8">
    <meta name="description" content="Équipe, Gym du Quartier, gym, forme physique, santé">
...
<body>
    <header>
        ...
        <nav>
            ...
            <ul id="gros">
                ...
                <li><span class="fa fa-star checked"></span></li>
                <li><a id="active" href="equipe.php" title="Notre Équipe">Notre Équipe</a></li>
                <li><span class="fa fa-star checked"></span></li>
    ...
    <main id="mainPortable">
        <h1>Nos Entraineurs Certifiés</h1>
        <article>
            ...
            <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                <div class="flipper">
                    <div class="front">
                        <h2>Barry Kade</h2>
                        <img src="../images/barry.jpg" title="Natation">
                    </div>
                    <div class="back">
            ...
            <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                <div class="flipper">
                    <div class="front">
                        <h2>Al Zeimers</h2>
                        <img src="../images/al.jpg" title="Yoga">
                    </div>
                    <div class="back">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean ultricies nisi at lacus suscipit ultricies. Quisque dignissim lacus velit, id aliquam sem condimentum sit amet. Cras condimentum mollis porttitor. Sed et nisl non nibh sagittis interdum. </p>
                    </div>
        ...
        <article>
            <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                <div class="flipper">
                    <div class="front">
                        <h2>Barb Akew</h2>
                        <img src="../images/barb.jpg" title="Haltérophilie">
                    </div>
                    <div class="back">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean ultricies nisi at lacus suscipit ultricies. Quisque dignissim lacus velit, id aliquam sem condimentum sit amet. Cras condimentum mollis porttitor. Sed et nisl non nibh sagittis interdum. </p>
                    </div>
            ...
            <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                <div class="flipper">
                    <div class="front">
                        <h2>Mary Krismass</h2>
                        <img src="../images/mary.jpg" title="Boot Camp">
                    </div>
                    <div class="back">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean ultricies nisi at lacus suscipit ultricies. Quisque dignissim lacus velit, id aliquam sem condimentum sit amet. Cras condimentum mollis porttitor. Sed et nisl non nibh sagittis interdum. </p>
                    </div>
